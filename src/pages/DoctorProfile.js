...
import { GetProfileDetails, UpdatePassword, UpdateProfilePic } from "../features/apiCall";
        ...
        >
          ...
          >
            <div className="d-flex align-items-center">
              <div className="profile-picture-container" style={{ marginRight: '40px', position: 'relative' }}>
                {isUploading ? (
